...
$SettingsFrame->addItem(new LQTextInputSaver('login', $oUser->getUserLogin(),
    _('přihlašovací jméno')));
$SettingsFrame->addItem(new EaseJQueryLinkButton('ChangePassword.php',
    _('změna hesla')));

$SettingsFrame->addItem(new LQTextInputSaver('email', $oUser->getUserEmail(),
    _('emailová adresa'), ['id' => 'UserMail']));

$SettingsFrame->addItem('<br>');

$SettingsFrame->addItem(new LQSendMailSwitcher('SendMail',
    _('Odesílat potvrzení o nové zkratce'), $oUser->getSettingValue('SendMail')));
